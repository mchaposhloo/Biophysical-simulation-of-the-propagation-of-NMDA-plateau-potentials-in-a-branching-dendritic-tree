...
for counter in 1:39
    ...
    R_spine_mem = 200;
    Spine_node = terminal_node_4-counter;
    ...
    pos[counter] = (terminal_node_4-Spine_node)*Δx;
...
plot!(pos[:],amplitudes[3,:],seriestype=:scatter,markershape = :hexagon,label = "4th child middle",legend = :topleft, legendfontsize =8,xaxis ="distance from the tip (cm)",yaxis ="voltage (mv)",ylim = (0,12.5))

savefig("FHN location of synapse.svg")
