...
for counter in 1:35
    ...
    V_clamp_4th_cild = solve_linear(A_sparse,V,terminal_node_4-1,40,0.01,100);
    d_avg[counter] = (d_0 + d_L)/2
    amplitudes[1,counter] = maximum(V_clamp_4th_cild[180,:])
    amplitudes[2,counter] = maximum(V_clamp_4th_cild[162,:])
    amplitudes[3,counter] = maximum(V_clamp_4th_cild[140,:])
    amplitudes[4,counter] = maximum(V_clamp_4th_cild[100,:])
    amplitudes[5,counter] = maximum(V_clamp_4th_cild[60,:])
    amplitudes[6,counter] = maximum(V_clamp_4th_cild[20,:])
    amplitudes[7,counter] = maximum(V_clamp_4th_cild[1,:])
end

plot(d_avg[:],amplitudes[7,:],seriestype=:scatter,markershape = :square,label = "soma")
plot!(d_avg[:],amplitudes[5,:],seriestype=:scatter,markershape = :circle,label = "1st child middle")
plot!(d_avg[:],amplitudes[4,:],seriestype=:scatter,markershape = :star,label = "2nd child middle")
plot!(d_avg[:],amplitudes[3,:],seriestype=:scatter,markershape = :hexagon,label = "4th child middle")
plot!(d_avg[:],amplitudes[2,:],seriestype=:scatter,markershape = :star4,label = "3rd child near bifurcation")
plot!(d_avg[:],amplitudes[1,:],seriestype=:scatter,markershape = :cross,label = "3rd child middle",legend = :topleft, legendfontsize =8,ylims = (0,35),xlims = (0,0.0004),xaxis ="average diameter (cm)",yaxis ="voltage (mv)")

savefig("fig 14.svg")

plot(d_avg[:],amplitudes[1,:] ./ amplitudes[7,:],seriestype=:scatter,markershape = :square,label = "soma")
plot!(d_avg[:],amplitudes[1,:] ./amplitudes[5,:],seriestype=:scatter,markershape = :circle,label = "1st child middle")
plot!(d_avg[:],amplitudes[1,:] ./amplitudes[4,:],seriestype=:scatter,markershape = :star,label = "2nd child middle")
plot!(d_avg[:],amplitudes[1,:] ./amplitudes[3,:],seriestype=:scatter,markershape = :hexagon,label = "4th child middle",xlims = (0,0.0004),xaxis ="average diameter (cm)",yaxis ="voltage ratio")
