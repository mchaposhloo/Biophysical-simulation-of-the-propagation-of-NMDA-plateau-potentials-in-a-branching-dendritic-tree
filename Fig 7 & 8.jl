...
d_0_branch_3_4 = 0.00004 #cm - diameter at the begining of the 2st branch
d_L_branch_3_4 = 0.00001 #cm - diameter at the end of the 2st branch
#the linear diameter function for the 2st branch
...
V_clamp_4th_cild = solve_linear(A_sparse,V,163,40,0.01,100);

t = 0:Δt:(M_t*Δt);

plot(t,V_clamp_4th_cild[180,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "",ylims = (0,14))

savefig("4th child middle.svg")

plot(t,V_clamp_4th_cild[140,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "",ylims = (0,14))

savefig("3rd child middle.svg")

plot(t,V_clamp_4th_cild[100,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "",ylims = (0,14))

savefig("2nd child middle.svg")

plot(t,V_clamp_4th_cild[60,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "",ylims = (0,14))

savefig("1st child middle.svg")

plot(t,V_clamp_4th_cild[20,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "",ylims = (0,14))

savefig("parent middle.svg")

plot(t,V_clamp_4th_cild[1,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "",ylims = (0,14))

savefig("soma.svg")

plot(t,V_clamp_4th_cild[180,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "third child middle")
plot!(t,V_clamp_4th_cild[162,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "third child near bifurcation")
plot!(t,V_clamp_4th_cild[120,:],title = "voltage over time",
    xaxis ="time (ms)",yaxis ="voltage (mv)", lw = 2.5,fmt = :svg,label = "second child near bifurcation")
