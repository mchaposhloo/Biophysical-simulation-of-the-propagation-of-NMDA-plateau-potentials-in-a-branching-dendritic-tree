...
for counter in 1:35
    ...
    amplitudes[1,counter] = maximum(V_spine_child_4_tip[180,:])
    amplitudes[2,counter] = maximum(V_spine_child_4_tip[163,:])
    amplitudes[3,counter] = maximum(V_spine_child_4_tip[140,:])
    amplitudes[4,counter] = maximum(V_spine_child_4_tip[100,:])
    amplitudes[5,counter] = maximum(V_spine_child_4_tip[60,:])
    amplitudes[6,counter] = maximum(V_spine_child_4_tip[20,:])
    amplitudes[7,counter] = maximum(V_spine_child_4_tip[1,:])
end

plot(d_avg[:],amplitudes[1,:],seriestype=:scatter,markershape = :cross,label = "3rd child middle",legend = :topright, legendfontsize =8,ylims = (0,15.5),xlims = (0,0.0004),xaxis ="average diameter (cm)",yaxis ="voltage (mv)")
